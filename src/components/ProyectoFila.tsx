...
export default function ProyectoFila({
  ...
  return (
    <article
      className={`grid grid-cols-1 items-start gap-x-6 gap-y-4 border-b border-linea py-7 lg:grid-cols-[3rem_minmax(0,1fr)_minmax(0,19rem)_7rem] ${
        destacado ? "bg-superficie px-4 lg:px-5" : ""
      }`}
    >
